 ...
 */
final class Version20240804114335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (id INT AUTO_INCREMENT NOT NULL, editor_id INT NOT NULL, title VARCHAR(255) DEFAULT NULL, isbn VARCHAR(255) DEFAULT NULL, cover VARCHAR(255) DEFAULT NULL, edit_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', plot LONGTEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, INDEX IDX_CBE5A3316995AC4C (editor_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
